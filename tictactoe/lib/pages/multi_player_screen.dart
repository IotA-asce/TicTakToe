...
import 'package:tictactoe/engine/engine.dart';
...
class _MultiPlayerScreenState extends State<MultiPlayerScreen> {
  ...
  void handleClick(int row, int col) {
    setState(() {
      gameControl.handleClick(row, col, context, false);
    });
  }

  @override
  Widget build(BuildContext context) {
    // the gameboard is assigned the complete width of the given screen
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height - 100;
    double size = width < height ? width < 400 ? width : 400 : height < 400 ? height : 400;
